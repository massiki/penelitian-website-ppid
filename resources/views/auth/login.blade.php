...
<body class="hold-transition login-page"
  style="background-image: url('{{ asset('assets/img/bg_login.jpg') }}'); background-size: cover; background-position: center;">
  <div class="login-box">
    <!-- /.login-logo -->
      ...
      <div class="card-body">
        <form action="/login" method="post">
          ...
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="NIP" inputmode="numeric" name="nip"
              id="nip" oninput="inputNip()" value="{{ old('nip') }}">
