        ...
        <tbody>
          @foreach ($informations as $item)
            <tr>
              ...
              <td class="text-start align-middle border" data-label="Ringkasan Informasi">{{ $item->ringkasan_informasi }}</td>
              ...
              <td class="align-middle border" data-label="Link">
                <a href="/informasi-publik/{{ $slug }}/{{ $item->id }}/details" class="btn btn-info" aria-label="Detail informasi">
