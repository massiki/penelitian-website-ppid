          ...
          <form action="/pengajuan/create" class="row" id="contact-form" method="POST">
            ...
            <div class="col-md-12 col-12">
              <div class="single-personal-info mb-0">
                ...
                <textarea id="information1" placeholder="Masukan Tujuan Penggunaan Informasi" name="tujuan_penggunaan_informasi"
                  required>{{ old('tujuan_penggunaan_informasi') }}</textarea>
